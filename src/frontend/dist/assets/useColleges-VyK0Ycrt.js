...
function ComparePanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-primary/30 rounded-2xl shadow-elevated p-4 flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GitCompare, { className: "w-4 h-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Compare" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: selectedColleges.map((college) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[120px] truncate", children: college.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          !canCompare && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex-1 self-center", children: [
            "Select ",
            2 - selectedColleges.length,
            " more to compare"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/compare", className: canCompare ? "w-full" : "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              disabled: !canCompare,
...
function ErrorState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-destructive/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-8 h-8 text-destructive" }) }),
...
Service({
  "getCollege": Func([Nat], [Opt(College)], ["query"]),
  "getColleges": Func([CollegeFilter], [PagedColleges], ["query"]),
  "getLocations": Func([], [Vec(Text)], ["query"]),
  "getSavedColleges": Func([], [Vec(College)], ["query"]),
  "saveCollege": Func(
    [Nat],
...
const idlFactory = ({ IDL: IDL2 }) => {
  const CollegeId2 = IDL2.Nat;
  const College2 = IDL2.Record({
    "id": CollegeId2,
    "courses": IDL2.Vec(IDL2.Text),
    "fees": IDL2.Nat,
    "name": IDL2.Text,
    "type": IDL2.Text,
    "established": IDL2.Nat,
    "description": IDL2.Text,
    "rating": IDL2.Float64,
    "placement_percentage": IDL2.Float64,
    "location": IDL2.Text
  });
  const CollegeFilter2 = IDL2.Record({
  ...
  const PagedColleges2 = IDL2.Record({
    "total": IDL2.Nat,
    "page": IDL2.Nat,
    "pageSize": IDL2.Nat,
    "colleges": IDL2.Vec(College2)
  });
  return IDL2.Service({
    "getCollege": IDL2.Func([IDL2.Nat], [IDL2.Opt(College2)], ["query"]),
    "getColleges": IDL2.Func([CollegeFilter2], [PagedColleges2], ["query"]),
    "getLocations": IDL2.Func([], [IDL2.Vec(IDL2.Text)], ["query"]),
    "getSavedColleges": IDL2.Func([], [IDL2.Vec(College2)], ["query"]),
    "saveCollege": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    "unsaveCollege": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    )
...
function to_candid_CollegeFilter_n2(_uploadFile, _downloadFile, value) {
...
function useBackendService() {
  ...
  const getColleges = async (filter) => {
    ...
    const result = await actor.getColleges({
      ...
      minFees: filter.minFees !== void 0 ? BigInt(filter.minFees) : void 0,
      maxFees: filter.maxFees !== void 0 ? BigInt(filter.maxFees) : void 0
    });
    return {
  ...
  const saveCollege = async (collegeId) => {
  ...
  const unsaveCollege = async (collegeId) => {
    if (!actor) return { success: false, error: "Not connected" };
